...
import br.cathenesi.rpg.domain.model.place.Cave;
import br.cathenesi.rpg.domain.model.place.House;
...
public class MapFactoryTest {
	...
	public void buildingMaps() throws Exception {
		...
		Assert.assertTrue(maps.get(0).getPlaces().get(0) instanceof House);
		Assert.assertEquals("Test Map 1", maps.get(0).getName());
		
		Assert.assertTrue(maps.get(1).getPlaces().get(0) instanceof Cave);
